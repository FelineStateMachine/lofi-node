...
#[derive(Clone)]
#[napi]
pub struct SendStream(pub(crate) Arc<Mutex<endpoint::SendStream>>); // lofi-node: pub(crate) for lofi_ext framing
...
#[derive(Clone)]
#[napi]
pub struct RecvStream(pub(crate) Arc<Mutex<endpoint::RecvStream>>); // lofi-node: pub(crate) for lofi_ext framing
